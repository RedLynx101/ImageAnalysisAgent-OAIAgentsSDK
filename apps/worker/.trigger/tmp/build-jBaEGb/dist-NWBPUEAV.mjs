...
// ../../../root/.npm/_npx/7372b51fc06f79a7/node_modules/@electric-sql/client/dist/index.mjs
init_esm();
...
var notifyUpToDateSubscribers_fn;
var sendErrorToUpToDateSubscribers_fn;
var reset_fn;
var _ShapeStream = class _ShapeStream2 {
  constructor(options) {
    ...
    return __async(this, null, function* () {
      ...
      try {
        while (!(signal == null ? void 0 : signal.aborted) && !__privateGet(this, _isUpToDate) || this.options.subscribe) {
          ...
          if (((_a = __privateGet(this, _replica)) != null ? _a : _ShapeStream2.Replica.DEFAULT) != _ShapeStream2.Replica.DEFAULT) {
...
_upToDateSubscribers = /* @__PURE__ */ new WeakMap();
...
_databaseId = /* @__PURE__ */ new WeakMap();
_schema = /* @__PURE__ */ new WeakMap();
_error = /* @__PURE__ */ new WeakMap();
_replica = /* @__PURE__ */ new WeakMap();
...
//# sourceMappingURL=dist-NWBPUEAV.mjs.map
