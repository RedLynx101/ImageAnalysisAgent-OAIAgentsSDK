...
// node_modules/@trigger.dev/sdk/node_modules/zod/lib/index.mjs
init_esm();
var util;
(function(util2) {
...
var ClockAPI = class _ClockAPI {
  ...
  setGlobalClock(clock2) {
    return registerGlobal2(API_NAME6, clock2);
  }
  preciseNow() {
  ...
  #getClock() {
    return getGlobal2(API_NAME6) ?? SIMPLE_CLOCK;
  }
};
...
var LoggerAPI = class _LoggerAPI {
  ...
  setGlobalTaskLogger(taskLogger) {
    return registerGlobal2(API_NAME7, taskLogger);
  }
  ...
  #getTaskLogger() {
    return getGlobal2(API_NAME7) ?? NOOP_TASK_LOGGER;
  }
};
...
var UsageAPI = class _UsageAPI {
  ...
  setGlobalUsageManager(manager) {
    return registerGlobal2(API_NAME8, manager);
  }
  disable() {
  ...
  #getUsageManager() {
    return getGlobal2(API_NAME8) ?? NOOP_USAGE_MANAGER;
  }
};
...
var RuntimeAPI = class _RuntimeAPI {
  ...
  setGlobalRuntimeManager(runtimeManager) {
    return registerGlobal2(API_NAME9, runtimeManager);
  }
  disable() {
  ...
  #getRuntimeManager() {
    return getGlobal2(API_NAME9) ?? NOOP_RUNTIME_MANAGER;
  }
};
...
var APIClientManagerAPI = class _APIClientManagerAPI {
  ...
  setGlobalAPIClientConfiguration(config) {
    return registerGlobal2(API_NAME10, config);
  }
  get baseURL() {
...
var TaskCatalogAPI = class _TaskCatalogAPI {
  ...
  setGlobalTaskCatalog(taskCatalog2) {
    return registerGlobal2(API_NAME11, taskCatalog2);
  }
  disable() {
  ...
  #getCatalog() {
    return getGlobal2(API_NAME11) ?? NOOP_TASK_CATALOG;
  }
};
...
async function loadSuperJSON() {
  return await import("./dist-4F2T4PDH.mjs");
}
...
@google-cloud/precise-date/build/src/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-SSCMVTO5.mjs.map
